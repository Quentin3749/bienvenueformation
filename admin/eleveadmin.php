...
class UserManager {
    ...
    public function registerUser($name, $firstname, $mail, $password, $confirmPassword) {
        if ($password === $confirmPassword) {
            ...
            if ($stmt->execute([$name, $firstname, $mail, $hashedPassword, $role])) {
                $this->displayMessage("Inscription réussie avec le rôle d'etudiant.");
            } else {
    ...
    public function displayUsers() {
        $sql = "
            ...
            WHERE users.role = 'etudiant'"; // Filtrer uniquement les étudiants
...
if (isset($_POST['ok'])) {
    ...
    $userManager->registerUser($name, $firstname, $mail, $password, $confirmPassword);
...
// Vérification de la mise à jour du rôle
